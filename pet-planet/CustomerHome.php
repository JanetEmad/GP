...
<main>
    ...
    <section class="hero-section d-flex justify-content-center align-items-center" style="background-image: url('assets/img/other/customerHomeBackground.jpg');     padding-top: 0px;
